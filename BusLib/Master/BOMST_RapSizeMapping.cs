...
{
    public class BOMST_RapSizeMapping
    {
        ...
        public DataTable Fill()
        {
            ...
            Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "PRI_RapSizeMappingGetData", CommandType.StoredProcedure);
            return DTab;
        }

        public RapSizeMappingProperty Save(RapSizeMappingProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
               // Ope.AddParams("ID", pClsProperty.ID, DbType.Int32, ParameterDirection.Input);
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "PRI_RapSizeMappingSave", CommandType.StoredProcedure);
        ...
        public RapSizeMappingProperty Delete(RapSizeMappingProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "PRI_RapSizeMappingDelete", CommandType.StoredProcedure);
