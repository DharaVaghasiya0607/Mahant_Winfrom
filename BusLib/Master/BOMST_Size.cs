...
namespace BusLib.Master
{
    public class BOMST_Size
    {
        ...
        public SizeMasterProperty SaveMix(SizeMasterProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
                ...
                Ope.AddParams("SIZEWISEDEPARTMENT_ID", pClsProperty.SIZEWISEDEPARTMENT_ID, DbType.String, ParameterDirection.Input); //HINAL 12/02/2022
        ...
        public SizeMasterProperty Delete(SizeMasterProperty pClsProperty)
        {
            try
            {
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "MST_SizeDelete", CommandType.StoredProcedure);
        ...
        public SizeMasterProperty DeleteMix(SizeMasterProperty pClsProperty)
        {
            try
            {
                Ope.ClearParams();
