...
namespace BusLib.Master
{
    public class BOMST_Year
    {
        ...
        public DataTable Fill()
        {
            ...
            Ope.FillDTab(Config.ConnectionString, Config.ProviderName, DTab, "MST_YearGetData", CommandType.StoredProcedure);
            return DTab;
        }
        ...
        public YearMasterProperty Delete(YearMasterProperty pClsProperty)
        {
            try
            {
                ...
                ArrayList AL = Ope.ExeNonQueryWithOutParameter(Config.ConnectionString, Config.ProviderName, "MST_YearDelete", CommandType.StoredProcedure);
