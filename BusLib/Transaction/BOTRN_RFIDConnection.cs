...
{
    public class BOTRN_RFIDConnection
    {
        ...
        public RFID_Device ConnectDevice()
        {
            ...
            try
            {
                ...
                //MessageBox.Show("Device Object Create..");
        ...
        public string LedOnAll(RFID_Device localDevice, List<string> tagsList)
        {
            ...
            //MessageBox.Show("tagsList Count First : " + tagsList.Count.ToString());

            localDevice.get_RFID_Device.DeviceBoard.setBridgeState(false, 167, 167);
            //MessageBox.Show("tagsList Count Second : " + tagsList.Count.ToString());
            ...
            //MessageBox.Show("tagsList Count Third : " + tagsList.Count.ToString());
