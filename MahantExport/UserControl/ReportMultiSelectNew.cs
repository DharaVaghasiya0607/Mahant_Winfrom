...
{
    public partial class ReportMultiSelectNew : DevExpress.XtraEditors.XtraUserControl
    {
        AxonDataLib.BOConversion Val = new AxonDataLib.BOConversion();
        public ReportMultiSelectNew()
        {
            InitializeComponent();
        }
            ...
            set
            {
                ...
                foreach (DataRow DRow in _DTab.Rows)
                {
                    if (Val.ToBoolean(DRow["ISGROUP"].ToString()) == true)
                    {
                        ...
                        ListViewItem.Text = DRow["COLUMNNAME"].ToString().ToUpper();
