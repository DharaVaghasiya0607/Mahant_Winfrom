...
{
    public partial class FrmStockAnalysis : DevControlLib.cDevXtraForm
    {
        ...
        private void BtnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet DS = ObjMemo.GetStockAnalysisReport(StrShape,
                    StrColor,
                    StrClarity,
                    StrCut,
                    StrPol,
              ...
              // DispalyChart(ChartDateWise, ViewType.Line, DS.Tables[2], "MEMODATE", "PARTICULAR");
                ...
                DispalyChart(ChartShape, ViewType.Pie, DS.Tables[1], "SHAPENAME", "PARTICULAR");

                DispalyChart(ChartColor, ViewType.Pie, DS.Tables[2], "COLORNAME", "PARTICULAR");

                DispalyChart(ChartClarity, ViewType.Pie, DS.Tables[3], "CLARITYNAME", "PARTICULAR");

                DispalyChart(ChartCut, ViewType.Pie, DS.Tables[4], "CUTNAME", "PARTICULAR");

                DispalyChart(ChartPol, ViewType.Pie, DS.Tables[5], "POLNAME", "PARTICULAR");

                DispalyChart(ChartSym, ViewType.Pie, DS.Tables[6], "SYMNAME", "PARTICULAR");

                DispalyChart(ChartFl, ViewType.Pie, DS.Tables[7], "FLNAME", "PARTICULAR");

                DispalyChart(ChartLocation, ViewType.Pie, DS.Tables[8], "LOCATIONNAME", "PARTICULAR");

                DispalyChart(ChartSize, ViewType.Pie, DS.Tables[9], "SIZENAME", "PARTICULAR");

                DispalyChart(ChartLab, ViewType.Pie, DS.Tables[10], "LABNAME", "PARTICULAR");
